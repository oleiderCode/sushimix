...
const sampleData = {
    employees: [
        ...
        { id: 4, name: "Francisco", position: "Cocinero", status: "active" },
    ...
    tips: [
        ...
        { date: "2025-08-08", amount: 190.00 }

    ],
    attendance: [
        { date: "2025-08-01", employeeId: 1, status: "present", extraHours: 2 },
        { date: "2025-08-01", employeeId: 2, status: "present", extraHours: 0 },
        { date: "2025-08-01", employeeId: 3, status: "absent", extraHours: 0 },
        { date: "2025-08-01", employeeId: 4, status: "present", extraHours: 1 },
        { date: "2025-08-01", employeeId: 5, status: "present", extraHours: 0 },
        { date: "2025-08-02", employeeId: 1, status: "present", extraHours: 0 },
        { date: "2025-08-02", employeeId: 2, status: "present", extraHours: 1 },
        { date: "2025-08-02", employeeId: 3, status: "present", extraHours: 0 },
        { date: "2025-08-02", employeeId: 4, status: "absent", extraHours: 0 },
        { date: "2025-08-02", employeeId: 5, status: "present", extraHours: 2 },
        {}
...
function loadCalculation() {
    ...
    const valuePerExtra = valuePerHour * 1;
